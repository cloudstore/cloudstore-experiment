...
public class Vm {
    ...
    public native boolean step(Callback cb) throws SQLite2.Exception;
    ...
    public native boolean compile() throws SQLite2.Exception;

    /**
     * Abort the compiled SQLite VM.
     */

    public native void stop() throws SQLite2.Exception;

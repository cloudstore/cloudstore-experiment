...
public class Database {
    ...
    public void open(String filename, int mode) throws SQLite2.Exception {
	if ((mode & 0200) != 0) {
    ...
    public void open_aux_file(String filename) throws SQLite2.Exception {
	synchronized(this) {
    ...
    public void close()	throws SQLite2.Exception {
	synchronized(this) {
	    _close();
	}
    }
    ...
    public void exec(String sql, SQLite2.Callback cb) throws SQLite2.Exception {
	synchronized(this) {
	    _exec(sql, cb);
	}
    }
    ...
    public void exec(String sql, SQLite2.Callback cb,
		     String args[]) throws SQLite2.Exception {
	synchronized(this) {
	    _exec(sql, cb, args);
	}
    }
    ...
    public TableResult get_table(String sql) throws SQLite2.Exception {
    ...
    public void set_encoding(String enc) throws SQLite2.Exception {
	synchronized(this) {
	    _set_encoding(enc);
	}
    }
    ...
    public Vm compile(String sql) throws SQLite2.Exception {
	synchronized(this) {
	    Vm vm = new Vm();
	    vm_compile(sql, vm);
	    return vm;
    ...
    public Vm compile(String sql, String args[]) throws SQLite2.Exception {
	synchronized(this) {
	    Vm vm = new Vm();
    ...
    public Stmt prepare(String sql) throws SQLite2.Exception {
	synchronized(this) {
	    Stmt stmt = new Stmt();
    ...
    public Blob open_blob(String db, String table, String column,
			  long row, boolean rw) throws SQLite2.Exception {
	synchronized(this) {
	    Blob blob = new Blob();
    ...
    public void key(byte[] ekey) throws SQLite2.Exception {
	synchronized(this) {
	    _key(ekey);
	}
    }
    ...
    public void key(String skey) throws SQLite2.Exception {
	synchronized(this) {
	    byte ekey[] = null;
    ...
    public void rekey(byte[] ekey) throws SQLite2.Exception {
	synchronized(this) {
	    _rekey(ekey);
	}
    }
    ...
    public void rekey(String skey) throws SQLite2.Exception {
	synchronized(this) {
	    byte ekey[] = null;
	    if (skey != null && skey.length() > 0) {
		ekey = new byte[skey.length()];
    ...
    public static long long_from_julian(String s) throws SQLite2.Exception {
	try {
	    double d = Double.parseDouble(s); // android-changed: performance
	    return long_from_julian(d);
	} catch (java.lang.Exception ee) {
	    throw new SQLite2.Exception("not a julian date");
	}
    }

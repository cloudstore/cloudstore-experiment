...
public class DelegateJDBCDriver implements Driver{
	...
	try {
		...
		cvers = "SQLite2.JDBC2w.JDBCConnection";
...
//	    }
	    ...
	    java.sql.DriverManager.registerDriver(new DelegateJDBCDriver());
	    try {
		String shcache =
		    java.lang.System.getProperty("SQLite2.sharedcache");
		if (shcache != null &&
	    ...
	    try {
		String tvfs = 
		    java.lang.System.getProperty("SQLite2.vfs");
		if (tvfs != null) {
		    vfs = tvfs;
		}
	    } catch (java.lang.Exception e) {
	...
	if (args[1] == null) {
	    args[1] = java.lang.System.getProperty("SQLite2.encoding");
	}
	if (args[4] == null) {
	    args[4] = vfs;
	}

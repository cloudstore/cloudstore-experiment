...
public class Vm {
    ...
    public native boolean step(Callback cb) throws SQLite2.SQLiteException;
    ...
    public native boolean compile() throws SQLite2.SQLiteException;

    /**
     * Abort the compiled SQLite VM.
     */

    public native void stop() throws SQLite2.SQLiteException;

...
public class JDBCDatabaseMetaData implements DatabaseMetaData {
	...
	public ResultSet getColumns(String catalog, String schemaPattern,
		...
		System.out.println("cat" + catalog + " sch " + schemaPattern +
				" table " + tableNamePattern + " column " + columnNamePattern);
		if (conn.db == null) {
			throw new SQLException("connection closed.");
		}
		if(tableNamePattern == null){
			return getColumnsForAllTables(catalog, schemaPattern, columnNamePattern);
		}
		TableResultX tr = getColumnsTableResult(catalog, schemaPattern, tableNamePattern, columnNamePattern);
		return new JDBCResultSet((SQLite.TableResult) tr, null);
	}
	
	private TableResultX getColumnsTableResult(String catalog, String schemaPattern,
	...
	private ResultSet getColumnsForAllTables(String catalog,
		...
		for(String tableName : tableNames){
			TableResultX tableResult = getColumnsTableResult(catalog,
					schemaPattern, tableName, columnNamePattern);
			for(String[] columnsRow : (Vector<String[]>)tableResult.rows){
				tr.newrow(columnsRow);
			}

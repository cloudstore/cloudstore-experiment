...
public class Stmt {
    ...
    public native boolean prepare() throws SQLite2.SQLiteException;
    ...
    public native boolean step() throws SQLite2.SQLiteException;

    /**
     * Close the compiled SQLite3 statement.
     */

    public native void close() throws SQLite2.SQLiteException;
    ...
    public native void reset() throws SQLite2.SQLiteException;

    /**
     * Clear all bound parameters of the compiled SQLite3 statement.
     */

    public native void clear_bindings() throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos, int value) throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos, long value) throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos, double value) throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos, byte[] value) throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos, String value) throws SQLite2.SQLiteException;
    ...
    public native void bind(int pos) throws SQLite2.SQLiteException;
    ...
    public native int bind_parameter_count() throws SQLite2.SQLiteException;
    ...
    public native String bind_parameter_name(int pos) throws SQLite2.SQLiteException;
    ...
    public native int column_int(int col) throws SQLite2.SQLiteException;
     ...
     */
    public native long column_long(int col) throws SQLite2.SQLiteException;
     ...
     */
    public native double column_double(int col) throws SQLite2.SQLiteException;
     ...
     */
    public native byte[] column_bytes(int col) throws SQLite2.SQLiteException;
     ...
     */
    public native String column_string(int col) throws SQLite2.SQLiteException;
     ...
     */
    public native int column_type(int col) throws SQLite2.SQLiteException;
    ...
    public native int column_count() throws SQLite2.SQLiteException;
    ...
    public Object column(int col) throws SQLite2.SQLiteException {
    ...
    public native String column_table_name(int col) throws SQLite2.SQLiteException;
    ...
    public native String column_database_name(int col) throws SQLite2.SQLiteException;
    ...
    public native String column_decltype(int col) throws SQLite2.SQLiteException;
    ...
    public native String column_origin_name(int col) throws SQLite2.SQLiteException;
